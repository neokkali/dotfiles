	...
	config = function()
		...
		require("tokyonight").setup({
			...
			on_highlights = function(highlights, colors)
				highlights.DiagnosticUnnecessary = { underline = true, fg = "#7FA6C7" }
				highlights["@lsp.typemod.variable.unused"] = { fg = "#7FA6C7" }
				highlights["@lsp.typemod.parameter.unused"] = { fg = "#7FA6C7" }
			end,
		})
